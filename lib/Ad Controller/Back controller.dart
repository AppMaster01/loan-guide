...
class BackButtonController extends GetxController {
  ...
  showBackbuttonad(BuildContext context, String name, var arg) async {
    if (CashLoan.value["BACKCOUNTER"] == Backbuttoncounter.value) {
      print(CashLoan.value[name]["INTER_AD_TYPE"]);
      showDialog(
      ...
      if (CashLoan.value[name]["INTER_AD_TYPE"] == 'ADMOB') {
        InterstitialAd.load(
          adUnitId: CashLoan.value[name]["INTER_ADMOB"],
          ...
          adLoadCallback: InterstitialAdLoadCallback(onAdLoaded: (ad) {
            ...
            InterstitialAd.load(
              adUnitId: CashLoan.value["interstitial"],
              // adUnitId: "/6499/example/interstitial",
              request: const AdManagerAdRequest(),
              adLoadCallback: InterstitialAdLoadCallback(onAdLoaded: (ad) {
                ad.show();
      ...
      if (CashLoan.value[name]["INTER_AD_TYPE"] == 'FB') {
        print("ads loading");
        FacebookInterstitialAd.loadInterstitialAd(
          placementId: CashLoan.value["INTER_FB"],
      ...
      if (CashLoan.value[name]["INTER_AD_TYPE"] == "URL") {
        // log("Loading");
